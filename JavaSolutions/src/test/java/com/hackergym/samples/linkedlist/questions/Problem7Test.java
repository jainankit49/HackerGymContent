...
public class Problem7Test {
    ...
    Problem7<String> solver = new Problem7<>();
    ...
    @Test
    public void testFlattenListCustom() throws Exception {
        Pair<BigListNode<String>, String[]> pair = LinkedListFactory.generateBigList();
        BigListNode<String> head = pair.fst;
        String[] expectedResult = pair.snd;
        Pair<BigListNode<String>, BigListNode<String>> resultPair = solver.flattenListCustom(head);
        BigListNode<String> resultHead = resultPair.fst;
    ...
    @Test
    public void testFlattenListCustomNoChildren() throws Exception {
