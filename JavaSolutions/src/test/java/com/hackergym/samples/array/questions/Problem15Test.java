...
public class Problem15Test {
    ...
    Problem15 pivoter = new Problem15();
    ...
    @Test
    public void testPerformPivotCustom() throws Exception {

        //arrange
        int[] array = {5 , 3 , 11, 2 , 8, 7, 9, 8, 1};

        //perform
        int[] result = pivoter.performPivotCustom(array, 4);
    ...
    @Test
    public void testPerformPivotCustomAllOnLeft() throws Exception {
        //arrange
        int[] array = {5 , 3 , 11, 2 , 8, 7, 9, 8, 1, 100};

        //perform
        int[] result = pivoter.performPivotCustom(array, 9);
    ...
    @Test
    public void testPerformPivotCustomAllOnRight() throws Exception {

        //arrange
        int[] array = {1, 5 , 3 , 11, 2 , 8, 7, 9, 8, 2};

        //perform
        int[] result = pivoter.performPivotCustom(array, 0);
    ...
    @Test
    public void testPerformPivotCustomAlreadyPivoted() throws Exception {

        //arrange
        int[] array = {5 , 3 , 4, 11 , 12, 18, 13};

        //perform
        int[] result = pivoter.performPivotCustom(array, 3);
